 ...
 * @version 1.0
 */
public class CustomPullListView extends ListView implements OnScrollListener {
	...
	public CustomPullListView(Context pContext, AttributeSet pAttrs) {
		super(pContext, pAttrs);
		init(pContext);
	}

	public CustomPullListView(Context pContext) {
		super(pContext);
		init(pContext);
	}

	public CustomPullListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
